...
export class OfferCard extends React.Component {
  render() {
    return (
      <div className="bg-white border cardborders w-100 my-5 d-flex flex-column justify-content-evenly">
        <div className="text-center pt-3">
          ...
          {this.props.specialoffer ? <h4>SAVE 134$ ANNUALLY</h4> : ""}
        </div>
...
"
              ...
              8 recommended option strategies
            </li>
            <li className="py-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
...
"
              ...
              Grading system for better options
            </li>
            <li className="py-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
